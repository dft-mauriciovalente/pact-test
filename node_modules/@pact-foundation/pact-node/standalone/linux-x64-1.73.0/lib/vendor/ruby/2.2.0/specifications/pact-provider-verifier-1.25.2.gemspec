# -*- encoding: utf-8 -*-
# stub: pact-provider-verifier 1.25.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<pact>.freeze, [">= 1.42.3", "~> 1.42"])
      ...
      s.add_runtime_dependency(%q<rake>.freeze, [">= 10.4.2", "~> 10.4"])
      ...
      s.add_dependency(%q<pact>.freeze, [">= 1.42.3", "~> 1.42"])
