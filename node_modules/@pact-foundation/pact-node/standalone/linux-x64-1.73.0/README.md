...
This version (1.73.0) of the Pact standalone executables package contains:

  * pact gem 1.42.3
  * pact-mock_service gem 3.2.0
  * pact-support gem 1.12.0
  * pact-provider-verifier gem 1.25.2
  * pact_broker-client gem 1.20.0
  * pact-message gem 0.6.0
...
Description:
  ...
  *production* version of the provider, however, it is sufficient if you are
  ...
  source (eg. git) and explicitly reference each one using one using the format
  ...
  It's best to specify the version explicitly.
